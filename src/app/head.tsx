...
export default function Head() {
  ...
  const canonical = `https://www.mortgage-lab.co.kr${path}`
  ...
  return (
    <>
      ...
      {/* SEO */}
      <meta name="description" content="모기지랩은 부동산 담보대출 조건을 전문가가 비교 분석해드리는 무료상담 플랫폼입니다." />
      <meta name="keywords" content="모기지랩,부동산 담보대출,비교견적,대환대출,추가대출" />
