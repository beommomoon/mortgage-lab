...
export const metadata = {
  ...
  description: '모기지랩은 수백 개 금융사의 담보대출 상품을 비교 분석하여, 고객님의 상황에 꼭 맞는 최적 조건을 찾아 무료로 상담해드립니다. 지금 바로 비교견적 받아보세요!',
  keywords: '모기지랩, 부동산 담보대출, 아파트 담보대출, 주택 담보대출, 대출 비교, 대출 상담, 정책자금',
  openGraph: {
    title: '모기지랩 | 부동산 담보대출 비교상담 플랫폼',
