  ...
  return (
    <main className="px-4 py-10 max-w-6xl mx-auto text-gray-800">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-10 mb-8 justify-start">
          {['가계자금', '사업자금', '매매잔금', '경매잔금', '보증서담보'].map((label, idx) => (
            <div
              key={idx}
              className="px-12 py-1.5 rounded-full bg-blue-100 border border-blue-300 text-blue-800 font-semibold text-base shadow-sm hover:scale-105 transition"
            >
              {label}
            </div>
          ))}
        ...
        <div className="space-y-12">
          <div>
            <p className="text-red-600 text-lg font-bold">가계자금대출이란?</p>
            <p className="leading-relaxed tracking-tight">
              직장인, 프리랜서, 주부 등 사업을 영위하지 않는 자로써 근로소득, 인정소득, 추정소득으로 소득을 환산하여 채무자 자격을 갖추고 부동산을 담보로 하여 진행하는 대출입니다.
            </p>
          </div>
          <div>
            <p className="text-red-600 text-lg font-bold">사업자금대출이란?</p>
            <p className="leading-relaxed tracking-tight">
              개인사업자, 법인사업자 등 세무서에 사업을 영위한다고 허가를 받고 사업소득의 증빙 등을 통해 채무자의 자격을 갖추고 부동산을 담보로 하여 진행하는 대출입니다.
            </p>
          </div>
          <div>
            <p className="text-red-600 text-lg font-bold">매매잔금대출이란?</p>
            <p className="leading-relaxed tracking-tight">
              부동산을 구입할 때 신청하는 대출로, 직장인, 사업자, 프리랜서 등 채무자의 자격을 갖추고 소득을 증빙할 수 있어야 하며 매매금액의 최대 70%까지 신청할 수 있습니다. (생애최초는 80%)
            </p>
          </div>
          <div>
            <p className="text-red-600 text-lg font-bold">경매잔금대출이란?</p>
            <p className="leading-relaxed tracking-tight">
              법원 경매나 공매를 낙찰받고 신청하는 대출이며, 낙찰금액의 80%까지 신청할 수 있습니다.<br />※ 금융사별로 세부사항이 다르니 꼭 확인 후 입찰하시기 바랍니다.
            </p>
          </div>
          <div>
            <p className="text-red-600 text-lg font-bold">보증서담보대출이란?</p>
            <p className="leading-relaxed tracking-tight">
              정책자금보증서, 신용보증재단 등 담보 외 보증서를 첨부하여 진행하는 특별한 대출로, 신청 조건 및 가능 여부는 사전 상담을 통해 확인하셔야 합니다.
            </p>
          </div>
        </div>
      </section>
